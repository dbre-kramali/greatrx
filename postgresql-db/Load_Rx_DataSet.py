...
DB_HOST = "db-postgresql-dbre.c70i46yce7ff.us-east-2.rds.amazonaws.com"
DB_PORT = 5432
DB_NAME = "GreatRx"
DB_USER = "postgres"   # <-- replace with your actual RDS master username
DB_PASSWORD = "HSI8KRMHThpLg8:_m_?x?$r8bwui" # <-- replace with your actual password
# ---------------------------------------------------
...
# -----------------------
drugs = [
    ("RX001","Amoxicillin","500 mg","Capsule","Generic Pharma"),
    ("RX002","Ibuprofen","200 mg","Tablet","HealthCorp"),
    ("RX003","Metformin","500 mg","Tablet","GlucoseCare"),
    ("RX004","Azithromycin","250 mg","Tablet","ZithroMed"),
    ("RX005","Lisinopril","10 mg","Tablet","CardioLife"),
    ("RX006","Atorvastatin","20 mg","Tablet","CholestoPharm"),
    ("RX007","Levothyroxine","75 mcg","Tablet","ThyroMed"),
    ("RX008","Omeprazole","20 mg","Capsule","GastroHeal"),
    ("RX009","Cetirizine","10 mg","Tablet","AllerFree"),
    ("RX010","Montelukast","10 mg","Tablet","RespiraCare"),
    ("RX011","Acetaminophen","500 mg","Tablet","PainAway"),
    ("RX012","Doxycycline","100 mg","Capsule","Antibiotix"),
    ("RX013","Prednisone","20 mg","Tablet","SteroidLabs"),
    ("RX014","Hydrochlorothiazide","25 mg","Tablet","Diurex"),
    ("RX015","Amlodipine","5 mg","Tablet","CardioPlus"),
    ("RX016","Clopidogrel","75 mg","Tablet","BloodFlow"),
    ("RX017","Insulin Glargine","100 units/mL","Injection","GlucoPharm"),
    ("RX018","Albuterol","90 mcg","Inhaler","BreathWell"),
    ("RX019","Fluoxetine","20 mg","Capsule","MindCare"),
    ("RX020","Sertraline","50 mg","Tablet","NeuroPharm"),
    ("RX021","Gabapentin","300 mg","Capsule","NeuroHeal"),
    ("RX022","Tramadol","50 mg","Tablet","PainRelief"),
    ("RX023","Losartan","50 mg","Tablet","CardioMed"),
    ("RX024","Warfarin","5 mg","Tablet","CoaguloPharm"),
    ("RX025","Furosemide","40 mg","Tablet","DiureCare"),
    ("RX026","Ciprofloxacin","500 mg","Tablet","Antibiotix"),
    ("RX027","Naproxen","500 mg","Tablet","PainAway"),
    ("RX028","Insulin Aspart","100 units/mL","Injection","GlucoPharm"),
    ("RX029","Budesonide","200 mcg","Inhaler","RespiraCare"),
    ("RX030","Pantoprazole","40 mg","Tablet","GastroHeal")
]
